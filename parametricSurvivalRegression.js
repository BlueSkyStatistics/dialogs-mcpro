...
class parametricSurvivalRegression extends baseModal {
    constructor() {
        var config = {
            id: "parametricSurvivalRegression",
...
`
        ...
        var objects = {
			...
			HazardRatioChk: {
                el: new checkbox(config, {
                    label: localization.en.HazardRatioChk, 
					no: "HazardRatioChk",
                    bs_type: "valuebox",
                    //style: "ml-3",
                    extraction: "BooleanValue",
			...
			coVarValues: { 
                el: new input(config, {
                    no: 'coVarValues',
                    label: localization.en.coVarValues,
					//style: "ml-5",
                    extraction: "TextAsIs",
                    allow_spaces:true,
                    type:"character"
...
module.exports.item = new parametricSurvivalRegression().render()
