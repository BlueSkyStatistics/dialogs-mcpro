...
class roctdcompriskcompare extends baseModal {
    static dialogId = 'roctdcompriskcompare'
    static t = baseModal.makeT(roctdcompriskcompare.dialogId)

    constructor() {
        var config = {
            id: roctdcompriskcompare.dialogId,
            label: roctdcompriskcompare.t('title'),
...
`
        ...
        var objects = {	
			...
			timevar: {
                el: new dstVariable(config, {
                    label: roctdcompriskcompare.t('timevarlabel'),
                    no: "timevar",
			...
			eventvar: {
                el: new dstVariable(config, {
                    label: roctdcompriskcompare.t('eventvarlabel'),
                    no: "eventvar",
                    filter: "Numeric|Scale",
                    extraction: "UseComma|Enclosed",
					required: true
			...
			eventcode: {
				el: new inputSpinner(config, {
					no: 'eventcode',
					label: roctdcompriskcompare.t('eventcodelabel'),
					min: 1,
					max: 1000,
					step: 1,
					value: 1,
			...
			markervars: {
                el: new dstVariableList(config, {
                    label: roctdcompriskcompare.t('markerslabel'),
                    no: "markervars",
                    filter: "Numeric|Scale",
			...
			time: {
                el: new input(config, {
                    no: 'time',
                    label: roctdcompriskcompare.t('timelabel'),
                    placeholder: "",
                    required: true,
                    type: "numeric",
			...
			controldef: {
                el: new selectVar(config, {
                    no: 'controldef',
                    label: roctdcompriskcompare.t('controldeflabel'),
                    multiple: false,
					width: "w-50",
					style: "mt-3",
                    extraction: "NoPrefix|UseComma",
			...
			multcompopt: {
				...
				label: roctdcompriskcompare.t('multcompopt'),
				no: "multcompopt",
				style: "mt-3",
				extraction: "Boolean"
				})
            ...
            multcompmethod: {
                el: new comboBox(config, {
                    no: 'multcompmethod',
                    label: roctdcompriskcompare.t('multcompmethod'),
					style: "ml-3",
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
            ...
            themedropdown: {
                el: new selectVar(config, {
                    no: 'themedropdown',
                    label: roctdcompriskcompare.t('themedropdownlabel'),
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
					width: "w-25",
			...
			plottitle: {
                el: new input(config, {
                    no: 'plottitle',
                    label: roctdcompriskcompare.t('plottitlelabel'),
			...
			plottitlesize: {
				el: new inputSpinner(config,{
				no: 'plottitlesize',
				label: roctdcompriskcompare.t('plottitlesize'),
				style: "mt-3",
				min: 5,
				max: 50,
				step: 1,
			...
			lineoptionslabel: { el: new labelVar(config, { label: roctdcompriskcompare.t('lineoptionslabel'), h: 5, style: "mt-4" }) },			
			linewidth: {
				el: new inputSpinner(config, {
					no: 'linewidth',
					label: roctdcompriskcompare.t('linewidthlabel'),
					min: .25,
					max: 10,
					step: 0.25,
					value: 1,
			...
			reflinechkbox: {
				el: new checkbox(config, {
					label: roctdcompriskcompare.t('reflinelabel'),
					no: "reflinechkbox",
					state: "checked",
            ...
            colorpalette: {
                el: new comboBox(config, {
                    no: 'colorpalette',
                    label: roctdcompriskcompare.t('colorpalette'),
					style: "ml-3",
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
			...
			axisoptionslabel: { el: new labelVar(config, { label: roctdcompriskcompare.t('axisoptionslabel'), h: 5, style: "mt-4" }) },
			axislabelsize: {
				el: new inputSpinner(config,{
				no: 'axislabelsize',
				label: roctdcompriskcompare.t('axislabelsize'),
				style: "ml-1",
				min: 5,
				max: 50,
				step: 1,
			...
			ticklabelsize: {
				el: new inputSpinner(config,{
				no: 'ticklabelsize',
				label: roctdcompriskcompare.t('ticklabelsize'),
				style: "ml-1",
				min: 5,
				max: 50,
				step: 1,
			...
			legendoptionslabel: { el: new labelVar(config, { label: roctdcompriskcompare.t('legendoptionslabel'), h: 5, style: "mt-4" }) },
            legendpos: {
                el: new comboBox(config, {
                    no: 'legendpos',
                    label: roctdcompriskcompare.t('legendpos'),
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
            ...
            legendtitle: {
                el: new input(config, {
                    no: 'legendtitle',
                    label: roctdcompriskcompare.t('legendtitle'),
                    placeholder: "Marker",
                    ml: 3,
                    extraction: "TextAsIs",
                    value: "Marker",
            ...
            curvelabels: {
                el: new input(config, {
                    no: 'curvelabels',
                    label: roctdcompriskcompare.t('curvelabels'),
                    placeholder: "",
                    ml: 3,
                    extraction: "TextAsIs",
                    value: "",
			...
			legendfontsize: {
				el: new inputSpinner(config,{
				no: 'legendfontsize',
				label: roctdcompriskcompare.t('legendfontsize'),
				style: "ml-1",
				min: 5,
				max: 50,
				step: 1,
        ...
        const content = {
            ...
            nav: {
                name: roctdcompriskcompare.t('navigation'),
                icon: "icon-icc",
                modal: config.id
            }
        };
        ...
        this.help = {
            title: roctdcompriskcompare.t('help.title'),
            r_help: roctdcompriskcompare.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: roctdcompriskcompare.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new roctdcompriskcompare().render()
}
