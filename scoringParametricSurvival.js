...
var localization = {
    en: {
        title: "Predicted parametric survival probabilities",
        label100: "This dialog outputs the predicted survival probability at one or more \nspecified times. \nThe following requirements must be met.\n1. You must have built a flexsurvreg parametric survival regression model on a dataset where 1 or higher value = event, 0 or lower value = censor. \n2. The dataset that you want to generate predictions for must have all the independent variables used to create \nthe original model. \n3. The timescale used for the time must match the timescale used to create the original model. \n4. If you want predictions for a single observation, you need to create a new dataset with that single observation.",
        navigation: "parametric survival scoring",
        
		filterModels: "Filter models by class",
        
		modelSelection: "Select a model to score a dataset",
        label1: "Diagnostic tests",
        followUpTime: "Specify one or more times e.g. 200, 1200, 1250, predicted survival and failure probabilities will be generated for each time",
		...
		label2: "Save survival and failure probabilities.",
        label3: "Predicted probabilities are stored as new variables (with prefixed if specified)",
        ...
        help: {
            title: "Score A Dataset Using A flexsurvreg (parametric survival) Model",
...
module.exports.item = new scoringParametricSurvival().render()